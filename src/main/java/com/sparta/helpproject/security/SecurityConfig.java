...
import com.sparta.helpproject.jwt.JwtAccessDeniedHandler;
import com.sparta.helpproject.jwt.JwtAuthenticationEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests()
                .mvcMatchers(HttpMethod.OPTIONS, "/api/**").permitAll() // CORS설정 관련 security 열어주기
